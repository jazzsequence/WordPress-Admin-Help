...
$this->tooltip_help_content['addplugin'] = '<p>' . __( 'Install a new plugin on your site.', 'ah-o2' ) . '</p>';
$this->tooltip_help_content['namecolumn'] = '<p>' . __( 'Currently available plugins on this site', 'ah-o2' ) . '</p>';
...
$this->tooltip_help_content['pluginsalltab'] = '<p>' . __( 'View all available plugins', 'ah-o2' ) . '</p>';
